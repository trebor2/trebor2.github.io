...
<h6>The final motor design. Optimized in Matlab around 13 variables (e.g., testing different types of magnets, 'pole' count, number of windings, ...). In production, this would be immersed in a resin-like epoxy, to waterproof/protect the internals from vibrations and rust. This is known as <a href="http://www.efipolymers.com/wp-content/uploads/2013/08/motors-10.jpg" target="_blank">potting</a>.</h6>
