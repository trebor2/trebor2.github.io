...
<h6>The final hip and knee motor design. Optimized in Matlab around 13 variables (e.g., testing different types of magnets, 'pole' count, number of windings, ...). In production, this would be immersed in a resin-like epoxy, to waterproof/protect the internals from vibrations and rust. This is known as <a href="http://www.efipolymers.com/wp-content/uploads/2013/08/motors-10.jpg" target="_blank">potting</a>. Note: their are only 3 components in this motor - the chassis, the stator, and a large bearing in the center. No screws or sensors (this type of motor allows for <a href="http://www.ti.com/ww/en/mcu/instaspin/index.shtml?DCMP=c2x-instaspin&HQS=instaspin" target="_blank">'sensorless' motion control</a>, although it does require some data from the ultrasonics to achieve proper orientation.)</h6>
