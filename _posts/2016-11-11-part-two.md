...
<h6>Metals are too rigid for an ergonomic exoskeleton. I decided to see what an exoskeleton using 3d printed carbon fiber as the primary material would look like. Everything in black is 3d printed carbon fiber, and the gold is magnesium.</h6>
